...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchGitHubRepos() {
    try {
      const response = await fetch("https://api.github.com/users/Jcnok/repos?sort=updated&per_page=6")
      ...
      repos.forEach((repo) => {
        ...
        // Generate random image for project
        const imageUrl = `https://source.unsplash.com/300x200/?data,technology,${repo.name}`
